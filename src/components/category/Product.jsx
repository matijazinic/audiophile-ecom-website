...
export default function Product({ item, index }) {
  ...
  return (
    <div
      key={item.slug}
      className="flex flex-col justify-center items-center gap-10 lg:grid lg:grid-cols-2"
    >
      ...
      >
        ...
        <p className="text-black/50 px-4 mb-14">{item.description}</p>
        <Link
